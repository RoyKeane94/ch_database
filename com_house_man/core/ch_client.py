...
class CompaniesHouseClient:
    ...
    def _get_paginated_items(self, endpoint):
        items = []
        start_index = 0
    ...
    def get_company_charges(self, company_number):
        return self._get_paginated_items(f"/company/{company_number}/charges")
    ...
    def get_company_officers(self, company_number):
        return self._get_paginated_items(f"/company/{company_number}/officers")
